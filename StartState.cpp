...
void StartState::DrawRulesScreen() {
	...
	case 2: 
		...
		wcout << L"     ├───────────────────────────────────────────────────────────────────────┨" << endl;
		wcout << L"     │ ⌂ This setting adds Jokers to the game pool.                          ┃" << endl;
		...
		wcout << L"     ├───────────────────────────────────────────────────────────────────────┨" << endl;
		wcout << L"     │ NUMBER OF ROUNDS                                                      ┃" << endl;
		wcout << L"     ├───────────────────────────────────────────────────────────────────────┨" << endl;
		wcout << L"     │ ⌂ By default the player goes through a single round of ten cards.     ┃" << endl;
		wcout << L"     │   However, they can go through a second round if they select it in    ┃" << endl;
		wcout << L"     │   the settings.                                                       ┃" << endl;
		wcout << L"     ├───────────────────────────────────────────────────────────────────────┨" << endl;
		...
		wcout << L"     │ ⌂ A loosing bet, loses the players bet.                               ┃" << endl;
		wcout << L"     │                                                                       ┃" << endl;
		wcout << L"     ┕━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛" << endl;
		break;
	case 3: 
		...
		wcout << L"     │ ⌂ If the player wins, their points / coins double.                    ┃" << endl;
		wcout << L"     │ ⌂ If the player loses, they lose all their points / coins.            ┃" << endl;
		wcout << L"     ┕━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛" << endl;
		MakeSpace(6);
		break;
	default:
		...
		wcout << L"     ├───────────────────────────────────────────────────────────────────────┨" << endl;
		wcout << L"     │ ⌂ The player is presented with one card face-up and ten face-down     ┃" << endl;
		...
		wcout << L"     ├───────────────────────────────────────────────────────────────────────┨" << endl;
		wcout << L"     │ ⌂ Each operation in the game can be selected by inputting a single    ┃" << endl;
		wcout << L"     │   character. Character codes are shown next to their respective       ┃" << endl;
		wcout << L"     │   operation.                                                          ┃" << endl;
		wcout << L"     │ ⌂ For Example: 'Back (B)' allows the player to go back by inputting   ┃" << endl;
		wcout << L"     │   'B'. Inputs work regardless of capitalisation. Inputting 'b' works  ┃" << endl;
